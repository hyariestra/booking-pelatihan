						...
						<div id="step-1">
							<div class="kontak">
								...
								<div id="form-step-0" role="form" data-toggle="validator">
									<div class="form-group">
										<input value="<?php $sess = $this->session->userdata('pelanggan'); echo $sess['nama_bumdes'] ?>"  onblur="getValueByAttr(this)" type="text" class="form-control" name="namabumdes" id="namabumdes" >
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div id="form-step-0" role="form" data-toggle="validator">
											<div class="form-group">
												<input value="<?php echo $sess['telp'] ?>" onblur="getValueByAttr(this)" type="text" class="form-control" name="telp" >
						...
						<div id="step-3">
								...
								<div style="" class="col-md-6">
										<div style="padding: 0;margin: 0;" class="radio">
											<label class="spanlabel">
												<input checked="" onchange="gettable(this);gettambahan(this);" onclick="getValueRadio(this);" type="radio" value="<?php echo $value['id_kat_instansi'] ?>#<?php echo $value['harga_ins'] ?>" name="instansi"><?php echo $value['nama_instansi'] ?></label>
							...
							<div class="row" style="background:#eee;color:#555;margin:0px;">
								<div class="col-md-9">
									<div class="checkbox">
									  <label class="spanlabel">
									  	<input type="checkbox" id="tugel" name="term">pemsanan terdapat <b style="color:#2091c9">syarat dan ketentuan</b> yang berlaku</label>
									</div>
								</div>
								<div class="col-md-3">
	...
	$(document).ready(function(){
		...
		var checkout = $('#tglselesai').datepicker({
		  ...
		  getLamaHari(ev);
			...
			getValueRadio()
			{
				var kategori = $("input[name='instansi']:checked").parent().text();
				console.log(kategori);
				$("#info_instansi").html(kategori);
