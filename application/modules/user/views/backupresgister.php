					...
					<div class="boxform">
							...
							<div class="kontak">
								...
								<div id="form-step-1" role="form" data-toggle="validator">
									<div class="form-group">
										<input onblur="getValueByAttr(this)" type="text" class="form-control" name="nama" id="nama" >
								...
								<div id="form-step-0" role="form" data-toggle="validator">
									<div class="form-group">
										<input onblur="getValueByAttr(this)" type="text" class="form-control" name="namabumdes" id="namabumdes" >
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div id="form-step-0" role="form" data-toggle="validator">
											<div class="form-group">
												<select name="propinsi" onchange="getKab(this)" class="form-control">
								...
								<div class="row">
									<div class="col-md-6">
										...
										<div id="form-step-0" role="form" data-toggle="validator">
											<div class="form-group">
												<input onblur="getValueByAttr(this)" type="text" class="form-control" name="telp" >
						...
						<div id="step-2">
								...
								<div class="col-md-6">
									...
									<div id="form-step-0" role="form" data-toggle="validator">
										<div class="form-group">
											<input onblur="getValueByAttr(this)" type="number" min="1" value="1" style="width:25%;"  class="form-control" name="jmlpeserta" id="jmlpeserta"  >
							...
							<div class="row">
								...
								<div class="col-md-4">
									...
									<div id="form-step-0" role="form" data-toggle="validator">
										<div class="form-group">
											<input type="text" role="tanggal" class="form-control" readonly name="tglselesai" id="tglselesai"  >
						...
						<div id="step-3">
								...
								<div style="" class="col-md-6">
									<div style="padding: 0;margin: 0;" class="radio">
									  <label class="spanlabel">
									  	<input onchange="gettable(this)" onclick="getValueRadio(this)" type="radio" value="<?php echo $value['id_kat_instansi'] ?>" name="instansi"><?php echo $value['nama_instansi'] ?></label>
							...
							<div id="form-step-0" role="form" data-toggle="validator">
								...
								<div class="col-md-12">
									...
									<div id="show-me">
										<textarea class="form-control" name="keterangan_produk" rows="5" id="comment"></textarea>
								...
								<div class="col-md-12">
									...
									<div id="form-step-0" role="form" data-toggle="validator">
										...
										<div class="col-md-6">
											...
											?>
											<div class="radio">
											  <label class="spanlabel"><input onclick="getValueRadio(this)" type="radio" value="<?php echo $value['id_lokasi_program'] ?>#<?php echo $value['harga_program'] ?>" name="program"><?php echo $value['nama_program']; ?></label>
											</div>
											<?php } ?>
							...
							<div class="boxaddtional">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="checkbox">
										  <label class="spanlabel"><input onclick="addon(this)" value="1" type="checkbox" name="addons[]">Wisata Desa</label>
										</div>
										<div class="checkbox">
										  <label class="spanlabel"><input onclick="addon(this)" value="2" type="checkbox" name="addons[]">Kaos</label>
										</div>
									</div>
									<div class="col-md-6">
										<div class="checkbox">
										  <label class="spanlabel"><input onclick="addon(this)" value="3" type="checkbox" name="addons[]">Sovenir dan oleh-oleh</label>
										</div>
										<div class="checkbox">
										  <label class="spanlabel"><input onclick="addon(this)" value="4" type="checkbox" name="addons[]">City Tour</label>
										</div>
									</div>
								</div>
							...
							<div class="row" style="background:#eee;color:#555;margin:0px;">
								...
								<div class="col-md-3">
									<button type="button" onclick="showmodalharga()" style="color:#fff;" class="btn btn-sm pull pull-right">
...
<div class="modal" id="modalharga" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
					...
					<div class="bodyinvoice">
						<div class="bodyoverflow">
							<table id="tblinvoice" class="table table-bordered" style="width:120% !important;">
								...
								<tr>
									<th><div id="info3_instansi" class="spantextlistattr">-</div></th>
									<th><div id="info4_instansi" class="spantextlistattr">-</div></th>
								</tr>
      ...
      <div class="modal-footer">
        <button onclick="simpandata()" type="button" class="btn btn-success">Setuju</button>
        <button type="button" class="btn btn-danger">Nego</button>
...
<script type="text/javascript">
	...
	function getValueRadio(obj)
	{
		...
		var four = eval(one)+eval(two)+eval(three);
	...
	*/
	function addon(obj)
	{
		...
		if(selected)
		{
			...
			var row = "<div id='addon_fasilitas_"+idx+"' class='col-md-6 pull pull-left'><div class='spantextlistattr'><span style='color:#8bc34a' class='glyphicon glyphicon-ok'></span> "+text+"</div></div>";
			$("#addonfasilitas").append(row);
			
		}
		else
		{
			$("#addon_fasilitas_"+idx).remove();
		}
	}
...
function show3()
{
	...
	function changetab(json) 
	{
		...
		for(i = 0; i < json.header.length; i++)
		{
			...
			var duittotal = json.body[i][x].duittot*$("input[name='jmlpeserta']").val();

			colbody0.innerHTML = Seq; 
			colbody1.innerHTML = keterangan; 
			colbody2.innerHTML = $("input[name='jmlpeserta']").val(); 
			colbody3.innerHTML = $("#info_lamapelatihan").text(); 
			colbody4.innerHTML = 'x'; 
			colbody5.innerHTML = satuan; 
			colbody6.innerHTML = duit; 
			colbody7.innerHTML = format1(duittotal, ""); 
