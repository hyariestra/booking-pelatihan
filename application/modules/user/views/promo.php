	...
	<div class="col-md-8">
		<div class="wizardbox">
			<form  id="myForm" role="form" data-toggle="validator" accept-charset="utf-8">
				...
				<div id="smartwizard">
					<ul>
						<li><a href="#step-1">Step 1<br /><small>Pilih Tanggal Pelatihan</small></a></li>
						<li><a href="#step-2">Step 2<br /><small>Informasi Pelatihan</small></a></li>
						<li><a href="#step-3">Step 3<br /><small>Informasi Diri</small></a></li>
					</ul>
						...
						<div id="step-1">
							<div class="tanggalpemesanan">
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="notifWizz">
												Tentukan Tanggal Pelatihan Anda
											</div>
									</div>
								...
								<div class="row">
									...
									<div id="form-step-0" role="form" data-toggle="validator">
										<div class="form-group">
											<input readonly="" type="text" value="14-03-2018" role="tanggal" class="form-control"  name="tglmulai" id=""  >
										</div>
									</div>
								</div>
								<div class="col-md-4">
									...
									<div id="form-step-0" role="form" data-toggle="validator">
										<div class="form-group">
											<input readonly="" value="16-03-2018" onblur="getvaldate(this);" type="text" role="tanggal" class="form-control"  name="tglselesai" id=""  >
									...
									<div class="col-md-12">
										...
										<div style="margin-bottom: 10px !important;" class="input-group">
										...
										<div style="" class="col-md-6">
											<div style="padding: 0;margin: 0;" class="radio">
												<label class="spanlabel">
													<input  onchange="gettambahan(this);" onclick="getValueRadio(this);" type="radio" value="<?php echo $value['id_kat_instansi'] ?>#<?php echo $value['harga_ins'] ?>" name="instansi"><?php echo $value['nama_instansi'] ?></label>
										...
										<div id="form-step-0" role="form" data-toggle="validator">
											...
											<div class="col-md-12">
												...
												foreach ($produk->result_array() as $key => $value) {
													...
													?>
													<div class="radio">
														<label class="spanlabel"><input onclick="getValueRadio(this);gettable(this);" type="radio" value="<?php echo $value['id_produk_want'] ?>#<?php echo $value['harga_produk'] ?>" name="produk"><?php echo $value['nama_produk'] ?></label>
													</div>
												...
												<input type="hidden" value="3" name="hari" id="dayz">
						...
						<div id="step-3">
							...
							<div class="row" style="background:#eee;color:#555;margin:0px;">
								<div class="col-md-9">
									...
									<div class="col-md-3">
										<button disabled="" id="disbutt" type="button" onclick="showmodalharga();gettable(this);" style="color:#fff;" class="btn btn-sm pull pull-right">
			...
			<div class="bodyright">
				...
				<div class="spantextatribute">
					...
					<div class="row">
						...
						<div class="col-md-6 pull pull-right">
							<div id="info_lamapelatihan" class="spantextlistattr">3 Hari</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 pull pull-left">
						...
						<div class="col-md-6 pull pull-right">
							<div id="tglmulaispan" class="spantextlistattr">Rabu, 14-03-2018</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-6 pull pull-left">
						...
						<div class="col-md-6 pull pull-right">
							<div id="tglselesaispan" class="spantextlistattr">Jumat, 16-03-2018</div>
						</div>
					</div>
				</div>
					...
					<div class="row">
						...
						<div class="col-md-6 pull pull-right">
							<span class="totalspan">
								<div id="duit"><small>Rp.</small>2.500.000,-</div>
							</span>
						</div>
					</div>
				</div>
...
<div class="modal" id="modalharga" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
				...
				<div class="kopinvoice">
					<div class="col-md-6">
						...
						<div class="row">
							...
							<div class="col-md-7">
								<span id="info2_lamapelatihan" class="spantextinvoice">3 Hari</span> 
							</div>
						</div>
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-7">
								<span class="spantextinvoice">Rabu, 14-03-2018 s/d
								Jumat, 16-03-2018</span> 
							</div>
						</div>
					</div>
					<div class="col-md-6">
      ...
      <div class="modal-footer">
        <button onclick="simpandata(this)" value="3" type="button" class="btn btn-success">Setuju</button>
...
<script type="text/javascript">
    ...
    defaultDate: '<?php echo date("2018-03-17") ?>',
	...
	function totharga()
	{
		var hargastatis = 2500000;
		var four = $("input[name='jmlpeserta']").val();
		
		var fournominal  = hargastatis*four;
		var fournominal = format1(fournominal, ""); 
...
function gettable(obj)
	{
		...
		var target = "<?php echo base_url("personil/promo") ?>";
		var data = {
	...
	function thattable(json)
	{
		...
		for (i = 0; i< json.promo.length; i++) {


			var bodyPromo = table.insertRow()
			var Seq = eval(i)+eval(1);
			var id_personil = json.promo[i].id_personil;
			var keterangan = json.promo[i].keterangan;
			var satuan = json.promo[i].satuan;
			var harga = json.promo[i].harga;
