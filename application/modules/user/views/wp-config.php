...
define('CLEANTALK_ACCESS_KEY', 'a9a2egura2eb');

// ** MySQL settings - You can get this info from your web host ** //
/** The name of the database for WordPress */
define('DB_NAME', 'bumdesid_wordpress');

/** MySQL database username */
define('DB_USER', 'bumdesid_user');
...
define('WP_HOME','http://bumdes.id');
define('WP_SITEURL','http://bumdes.id');
