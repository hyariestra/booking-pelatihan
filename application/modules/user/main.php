...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="item active">
        <img style="height: 350 !important;" src="<?php echo base_url("theme/images/slider/slide1.jpg") ?>" alt="Los Angeles" style="width:100%;">
      </div>

      <div class="item">
        <img style="height: 350 !important;" src="<?php echo base_url("theme/images/slider/slide2.jpg") ?>" alt="Chicago" style="width:100%;">
      </div>
    
      <div class="item">
        <img style="height: 350 !important;" src="<?php echo base_url("theme/images/slider/slide3.jpg") ?>" alt="New york" style="width:100%;">
      </div>
    </div>
...
<div class="w3ls_banner_info_grids2">
	<div class="boxbackover">
		...
		<div class="container col-container">
			<div class="col-md-12">
				<div class="marginauto" style="padding-left:15%; padding-right:5%;">
		...
		<?php foreach ($tampilpaket as $key => $value) {
		 ...
		 ?>
			...
			<div class="headerpaket paket">
				<div class="headerpaket-text"><?php echo $value['nama_instansi'] ?></div>
				<div class="headerpaket-price">
					<span class="spantext-rp">Rp.</span><span class="spantext-nominal"><?php echo $value['harga_paket'] ?></span>
				</div>
			...
			<div style="border:2px solid #eee; height: 250px;" class="bodypaket">
				...
				<ul class="listpaket">
					...
					foreach ($fasilitas as $key => $val) {
						...
						<li><span style="color:#8bc34a;" class="glyphicon glyphicon-ok"></span> <?php echo $query->first_row()->keterangan; ?></li>	

						<?php } ?>
					</ul>

					<a href="<?php echo base_url("user/register/$value[id_kat_instansi]"); ?>"><button style="color:#fff;" class="btn btn-md"><span style="color:#8bc34a;" class="glyphicon glyphicon-ok"></span>  Pesan Sekarang</button></a>
			</div>
...
<div class="about-w3l">
  	<div class="container">
  		...
  		<ul class="nav nav-pills">
  			<li class="active"><a  style="padding:10px 30px 10px 30px" data-toggle="pill" href="#home">Pakaian</a><!-- </li>
  		...
  		<div class="tab-content">
  			<div id="home" class="tab-pane fade in active">
  					...
  					<div class="col-md-3">
  						...
  						<div class="thumbnail">
  							<img src="<?php echo base_url("theme/images/kaosbumdes.jpg"); ?>" alt="...">

  							<div class="caption">
  								<h3>Kaos Bumdes</h3>
  								<p>Rp. 95.000,00</p>
  							<a style="margin-left: 15%;" href="<?php echo base_url("item/detail"); ?>"><button style="color:#fff;" class="btn btn-md"><span style="color:#8bc34a;" class="glyphicon glyphicon-ok"></span>  Pesan Sekarang</button></a>
  							</div>
  						</div>
  					</div>
	...
	<div class="about-w3l">
		<div class="container">
			...
			<div style="margin-bottom: 40px;" class="col-md-10 col-md-offset-1 ab-left">
				...
				<img title="Sri Martani"  style="margin-bottom: 10px; margin-right: 20px; width: 100px; height:100px" src="<?php echo base_url("theme/images/partner/7.jpeg"); ?>" alt=" " />
				<img title="Panggung Lestari"  style="margin-bottom: 10px; margin-right: 20px; width: 120px; height:100px" src="<?php echo base_url("theme/images/partner/6.jpeg"); ?>" alt=" " />
			</div>
		</div>
	</div>
	...
	<div class="team" id="team">
		<div class="container">
			<div class="w3-agileits-team-title">
				<h3 class="w3l-titles">Konsultan Bumdes.id</h3>
				<div id="horizontalTab">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<img class="righty" style=" border-radius: 50%;"  src="<?php echo base_url("theme/images/pemateri120px/tab3.jpg"); ?>" alt=" " align="left" class="img-responsive" />
							<div class="lefy">
