		...
		<div class="box">
			...
			<div class="box-body">
				...
				<table class="table" id="tabelku">
					...
					<?php foreach ($tampilpromo as $key => $value): ?>
					...
					<!-- karena data banyak dan array , ditampilkan pakai foreach -->
						...
						<tr>
							...
							<td><?php echo $key+=1; ?>
								<input type="hidden" id="idtable" value="<?php echo $value['id_promo'] ?>" name="">
							</td>
							...
							<?php $stat = ($value['status']==1)?'Aktif': 'TidaK Aktif' ?>
						...
						<td>
							<button onclick="ambildata(this,'<?php echo $value['id_promo'] ?>')" class="btn btn-sm btn-warning" style="margin-bottom:10px;">
								<span class="glyphicon glyphicon-pencil">

								</span> Edit Data
							</button>

							<button onclick="hapusdata(this,'<?php echo $value['id_promo'] ?>')" class="btn btn-sm btn-danger" style="margin-bottom:10px;">
