				...
				<form method="post" enctype="multipart/form-data">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" onblur="permalink()" name="nama_produk" class="form-control" value="<?php echo $produk['nama_produk']; ?>">

						</div>

					

							<input type="hidden"  name="nama_permalink" class="form-control" value="<?php echo $produk['nama_permalink']; ?>">
...
<script>
	...
	{	
		...
		if (msg) {
			var target = "<?php echo site_url("product/hapusprodukz") ?>";
