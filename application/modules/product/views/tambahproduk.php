				...
				<form method="post" enctype="multipart/form-data">
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<input type="text" onblur="permalink()" name="nama_produk" class="form-control">
							...
							<input type="hidden" name="nama_permalink" class="form-control">
...
$(document).ready(function() {
    ...
    $(add_button).click(function(e){
        ...
        if(x < max_fields){
            x++;
            $(wrapper).append('<div class="row"><div class="col-md-12"><div class="col-md-10"><input type="file" name="gambar_produk[]" class="form-control"></div><div class="col-md-1"><button type="button" class="btn btn-sm btn-success add_form_field"><span class="glyphicon glyphicon-plus-sign"></span></button></div><div class="col-md-1"><a href="#" class="delete">Delete</a></div></div></div>'); //add input box
        }
  else
  {
  ...
  alert('Gambar Melebihi Batas')
	...
	function permalink()
	{
		var name = $("input[name='nama_produk']").val();

		var rep =  name.replace(/[ ]/g,'-');
		 var lower = rep.toLowerCase()

		$("input[name='nama_permalink']").val(lower+'.html');
		//alert(left);
	}
</script>